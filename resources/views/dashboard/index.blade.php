    ...
    <section class="flex flex-col md:flex-row gap-6">
        ...
        <div class="bg-white p-8 rounded-lg shadow-md w-full">
            ...
            <div class="flex justify-between items-center border-b-2 border-gray-200 py-2">
                ...
                <div class="flex space-x-4">
                    <a href="{{ route('jobs.edit', $job->id) }}"
                        class="bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded text-sm">Edit
                    </a>
            ...
            <div class="mt-4">
                ...
                <p class="text-gray-700 bg-amber-200 p-2 px-5 rounded-lg">No applicants for this job</p>
...
{{-- @if(count($jobs) > 10)
<p>You have many job listings!</p>
@elseif(count($jobs) > 5)
<p>You have several job listings.</p>
@elseif(count($jobs) > 0)
<p>You have a few job listings.</p>
@else
